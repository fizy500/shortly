...
export default function Boost () {
  return (
    <div>
      <div className='bg-[url(./assets/bg-boost-mobile.svg)] lg:bg-[url(./assets/bg-boost-desktop.svg)] bg-[#3B3054] bg-cover bg-center bg-no-repeat px-5 py-16 flex flex-col justify-center items-center  space-y-4  w-full'>
